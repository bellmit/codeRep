...
public class HttpConnection implements Connection {
	...
	public Connection proxy(String ip, int port) {
	...
	public org.jsoup.Connection.Response execute(String charset) throws IOException {
		res = Response.execute(req, charset);
		return res;
	}
	...
	public static class Response extends Base<Connection.Response> implements Connection.Response {
		...
		static Response execute(Connection.Request req, String charset) throws IOException {
			return execute(req, null, charset);
		}

		static Response execute(Connection.Request req) throws IOException {
			return execute(req, null, DataUtil.defaultCharset);
		}

		static Response execute(Connection.Request req, Response previousResponse) throws IOException {
			return execute(req, previousResponse, DataUtil.defaultCharset);
		}

		static Response execute(Connection.Request req, Response previousResponse, String charset) throws IOException {
			...
			try {
				...
				if (req.method() == Connection.Method.POST)
					writePost(req.data(), conn.getOutputStream(), charset);
				...
				try {
					...
					bodyStream = res.hasHeader("Content-Encoding") && res.header("Content-Encoding").equalsIgnoreCase("gzip") ? new BufferedInputStream(new GZIPInputStream(dataStream))
		...
		private static void writePost(Collection<Connection.KeyVal> data, OutputStream outputStream, String charset) throws IOException {
			OutputStreamWriter w = new OutputStreamWriter(outputStream, charset == null ? DataUtil.defaultCharset : charset);
			boolean first = true;
			for (Connection.KeyVal keyVal : data) {
				...
				w.write(URLEncoder.encode(keyVal.key(), charset == null ? DataUtil.defaultCharset : charset));
				w.write('=');
				w.write(URLEncoder.encode(keyVal.value(), charset == null ? DataUtil.defaultCharset : charset));
			}
			w.close();
		}
