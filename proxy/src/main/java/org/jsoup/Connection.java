...
public interface Connection {
	...
	/**
	 * new Proxy(Proxy.Type.HTTP, new InetSocketAddress("192.168.100.253",
	 * 8888))
	 * 
	 * @param proxy
	 * @return
	 ...
	 *             if the request URL is not a HTTP or HTTPS URL, or is
	 *             otherwise malformed
	 * @throws HttpStatusException
	 *             if the response is not OK and HTTP response errors are not
	 *             ignored
	 * @throws UnsupportedMimeTypeException
	 *             if the response mime type is not supported and those errors
	 *             are not ignored
	...
	public Response execute(String charset) throws IOException;
	...
	public interface Request extends Base<Request> {
		 ...
		 * 
		 * @param bytes
		 *            maximum body size, in milliseconds.
		 * @return this Request, for chaining
		 */
